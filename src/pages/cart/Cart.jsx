...
const Cart = () => {
  ...
  const discountRate = 0.2; // Define the discount rate (20%)
  ...
  useEffect(() => {
    ...
    const discountAmount = productData.length > 0 ? price * discountRate : 0;
    // const deliveryAmount = productData.length > 0 ? price
            ...
            <div>
              <div className=" flex flex-col gap-4 py-5 border-b-2">
                ...
                <div className="flex justify-between">
                  ...
                  {discountAmt > 0 && <p className="font-titleFont text-[20px] font-bold text-red-500">
                    -${discountAmt}
                  </p>}
                </div>
                <div className="flex justify-between">
